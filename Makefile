...
ACLOCAL = ${SHELL} /root/server/dante-1.4.1/missing --run aclocal-1.11
AMTAR = ${SHELL} /root/server/dante-1.4.1/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/server/dante-1.4.1/missing --run autoconf
AUTOHEADER = ${SHELL} /root/server/dante-1.4.1/missing --run autoheader
AUTOMAKE = ${SHELL} /root/server/dante-1.4.1/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LDFLAGS = 
LEX = ${SHELL} /root/server/dante-1.4.1/missing --run flex
LEXLIB = 
LEX_OUTPUT_ROOT = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/server/dante-1.4.1/missing --run makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
TOPEXTRADIST = 
TOPSUBDIRS =  include sockd unlicensed example doc bin SPECS capi contrib
UNITSUBDIRS = sockd 
VERSION = 1.4.1
YACC = yacc
YFLAGS = 
abs_builddir = /root/server/dante-1.4.1
abs_srcdir = /root/server/dante-1.4.1
abs_top_builddir = /root/server/dante-1.4.1
abs_top_srcdir = /root/server/dante-1.4.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
ac_krb5_config = 
...
install_sh = ${SHELL} /root/server/dante-1.4.1/install-sh
...
_reconf: $(top_srcdir)/lib/Makefile.am $(top_srcdir)/dlib/Makefile.am $(top_srcdir)/sockd/Makefile.am
