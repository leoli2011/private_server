...
ACLOCAL = ${SHELL} /letv/server/private_server/missing --run aclocal-1.11
AMTAR = ${SHELL} /letv/server/private_server/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /letv/server/private_server/missing --run autoconf
AUTOHEADER = ${SHELL} /letv/server/private_server/missing --run autoheader
AUTOMAKE = ${SHELL} /letv/server/private_server/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /letv/server/private_server/missing --run makeinfo
MANIFEST_TOOL = :
...
YACC = bison -y
YFLAGS = 
abs_builddir = /letv/server/private_server
abs_srcdir = /letv/server/private_server
abs_top_builddir = /letv/server/private_server
abs_top_srcdir = /letv/server/private_server
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
ac_krb5_config = 
...
install_sh = ${SHELL} /letv/server/private_server/install-sh
